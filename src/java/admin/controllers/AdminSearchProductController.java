...
public class AdminSearchProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int totalRecords = productDAO.getTotalRecord(txtSearch, 0, 0, Integer.parseInt(cbCategory), status, 0);
            ...
            if (totalRecords > 0) {
                ...
                List<ProductDTO> listProduct = productDAO.getList(txtSearch, 0, 0, Integer.parseInt(cbCategory), status, 0, (pageNum - 1) * ROWS_PER_PAGE, ROWS_PER_PAGE);
